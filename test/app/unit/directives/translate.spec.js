describe('i18n-directive', function() {
  ...
  describe('translateAttr', function() {
    ...
    it('should replace the value of the attribute with the translation with the original value of the attribute as key', inject(function () {
      var elm = compile( '<input type="submit" translate-attr="value" value="test.key.1" />' )( scope );
      expect(elm.attr('value')).toBe('translation1');
    }));

    it('should replace the value of the attribute with the original value of the attribute when not found', inject(function () {
